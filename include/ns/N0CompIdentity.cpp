...
void N0CompIdentity::LoadFromBin(const ur::Device& dev, const std::string& dir, bs::ImportStream& is)
{
...
void N0CompIdentity::StoreToMem(const ur::Device& dev, n0::CompIdentity& comp) const
{
