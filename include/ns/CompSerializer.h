...
public:
	...
	using FromJsonFunc = std::function<void(const ur::Device&, n0::NodeComp&, const std::string&, const rapidjson::Value&)>;
	...
	void FromJson(const ur::Device& dev, n0::NodeComp& comp, const std::string& dir,
	...
	using FromBinFunc = std::function<void(const ur::Device&, n0::NodeComp&, const std::string&, bs::ImportStream& is)>;
	...
	void FromBin(const ur::Device& dev, n0::NodeComp& comp, const std::string& dir,
