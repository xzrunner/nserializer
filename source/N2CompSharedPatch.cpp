...
void N2CompSharedPatch::LoadFromBin(const ur::Device& dev, const std::string& dir, bs::ImportStream& is)
{
	// todo
}
...
void N2CompSharedPatch::LoadFromJson(const ur::Device& dev, mm::LinearAllocator& alloc, const std::string& dir, const rapidjson::Value& val)
{
...
void N2CompSharedPatch::StoreToMem(const ur::Device& dev, n2::CompSharedPatch& comp) const
{
