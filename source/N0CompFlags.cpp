...
void N0CompFlags::LoadFromBin(const ur::Device& dev, const std::string& dir, bs::ImportStream& is)
{
...
void N0CompFlags::LoadFromJson(const ur::Device& dev, mm::LinearAllocator& alloc, const std::string& dir, const rapidjson::Value& val)
{
	m_visible  = val["visible"].GetBool();
	m_editable = val["editable"].GetBool();
}

void N0CompFlags::StoreToMem(const ur::Device& dev, n0::CompFlags& comp) const
{
