...
void N2CompShape::LoadFromBin(const ur::Device& dev, const std::string& dir, bs::ImportStream& is)
{
	// todo
}
...
void N2CompShape::LoadFromJson(const ur::Device& dev, mm::LinearAllocator& alloc, const std::string& dir, const rapidjson::Value& val)
{
	m_type = val["type"].GetString();
}

void N2CompShape::StoreToMem(const ur::Device& dev, n2::CompShape& comp) const
{
